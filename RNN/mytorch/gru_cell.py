...
class GRUCell(object):
    ...
    def forward(self, x, h):
        ...
        self.a = self.Wnh @ self.hidden + self.bnh
    ...
    def backward(self, delta):
        ...
        self.dWrx += dr.T @ self.x.reshape(1, self.d)
        self.dWzx += dz.T @ self.x.reshape(1, self.d)
        self.dWnx += dn.T @ self.x.reshape(1, self.d)

        self.dWrh += dr.T @ self.hidden.reshape(1, self.h)
        self.dWzh += dz.T @ self.hidden.reshape(1, self.h)
        self.dWnh += (dn * self.r).T @ self.hidden.reshape(1, self.h)
        ...
        dh = self.r * dn @ self.Wnh + dz @ self.Wzh + dr @ self.Wrh + self.z * delta
